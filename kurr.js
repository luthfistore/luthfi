...
quickReplyButton: {
displayText: 'VaaXdHosting',
id: 'pemcet'
}
}]
fatihgans = fs.readFileSync('./lib/assets/logo.jpg'), 
kurr.send5ButImg(m.chat, Anu, ` BOT BY LUTHFI BOTZ `, fatihgans, btn)
break
case 'listpc': {		
...
if (!isCreator) throw  m.reply(`Lu Siapa Ajg`)
        ...
        axios.get(`https://raynesia.kevinstore.me:2087/json-api/removeacct?api.version=1&username=${uname}`, { headers: { Authorization: "Basic " + Buffer.from("root:@@serverRaynesia.Id2022@@").toString("base64") } })
...
case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Group`, '© Copyright By LUTHFI BOTZ', m)
...
if(from != "ID GROUPNYA") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(`𝗦𝗖 𝗞𝗛𝗨𝗦𝗨𝗦 𝗣𝗛𝗜𝗦𝗜𝗡𝗚 !!\n𝗦𝗖 : https://wa.me/6283103592954?text=bang+buy+sc+bot`)
                                          break
case 'promote': {
		if (!m.isGroup) throw mess.group
                if (!isBotAdmins) throw mess.botAdmin
...
case 'donasi': {
	...
	break
case 'payment': {
              m.reply(`*✪ALL PAYMENT VAAXD HOSTING✪*

⭔DANA : *tidak tersedia*
Atas Nama : M****** L**** W***
⭔GOPAY : https://postimg.cc/tZKHsPr9
Atas Nama : V** K*****
⭔QRIS ALL PAY/NOPREM :
https://postimg.cc/mzNPjb0f

*NOTE : KLO TF KE QRIS TAMBAHIN 2K YA BUAT PAJAK :)*`)
	}
	break
	    case 'setname': case 'setsubject': {
          ...
          case 'setppbot': {
           ...
           case 'setppgroup': case 'setppgrup': case 'setppgc': {
                ...
                break
case 'webp1':
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(`Done ✓

Link Mediafıre sering : 
...
NOTE : DILARANG JUAL BELIKAN !! KARNA INI KHUSUS ✓`)
                                          break
case 'webp4':
if(from != "ID GRUP") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(`Done ✓
...
NOTE : DILARANG JUAL BELIKAN !! KARNA INI KHUSUS ✓`)
                                          break
case 'testi':
                                          m.reply(` 𝗧𝗘𝗦𝗧𝗜𝗠𝗢𝗡𝗜 𝗕𝗬 𝗬𝗢𝗦¹⁹ !!\n𝗡𝗜 𝗧𝗘𝗦𝗧𝗢𝗗 : https://imageshack.com/user/`)
                                          break
case 'shorlink':
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗦𝗛𝗢𝗥𝗟𝗜𝗡𝗞 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://tinyurl.com\n\nKey : -`)
                                          break
case 'loginwhm':
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://raynesia.kevinstore.me:2087\nKALO EROR JANGGAN MAKSA KONTOLL:V`)
                                          break
case 'logincpanel':
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(` 𝗟𝗢𝗚 𝗪𝗛𝗠 𝗡𝗬𝗔 𝗠𝗔𝗦𝗭𝗘𝗛𝗛𝗛 !!\n𝗟𝗜𝗡𝗞 : https://raynesia.kevinstore.me:2083\nKALO EROR JANGGAN MAKSA KONTOLL:V`)
                                          break
case 'listpc': {
if (!isCreator) throw mess.owner
...
case 'linkadd':
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
                                          m.reply(`𝗟𝗜𝗡𝗞 𝗔𝗗𝗗 𝗡𝗬𝗔 𝗢𝗢𝗠 !!\n𝗟𝗜𝗡𝗞 : https://tools-addpackage-host.gtwdah.my.id`)
                                        break
case 'listdomain1': {
if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
...
contoh : https://vaaxdganteng.barux2022.tk
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/UCnGK_AMdGmq7pSx8mpdd9rg'
                                }
                            }, {
                                urlButton: {
                                    displayText: '❝𝐆𝐑𝐔𝐏 𝐖𝐀 𝐁𝐎𝐓❞',
...
┃┊◎ .domain6 |  
┃
┃ MAO NAMBAHIN DOMAIN ? CHAT VAAXD🤖
┃
┗━❁━┈━❁━┈━❁━┈━❁━┛
...
case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await kurr.sendButtonText(m.chat, buttons, `Mode Antilink`, '© VaaXd-MD', m)
                }
             }
             break
...
case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      kurr.send5ButImg(i, txt, '© VAAXDHosting', global.thumb, btn)
                    }
         ...
         if(from != "120363026733773313@g.us") return m.reply("maaf su fitur ini dapet di gunakan group tertentu")
        let sUser1 = "root";
        let sPass1 = "@@serverRaynesia.Id2022@@";
        let serverName1 = "tools-addpackage-host.gtwdah.my.id";
